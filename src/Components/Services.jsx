...
const Services = () => {
  return (
    <>
        <div className='flex flex-col gap-4 laptop:mt-10 mobile:mt-9.5 laptop:px-10 mobile:px-5'>
        ...
        <div className='bg-[url("/seamless.png")] flex mobile:flex-col laptop:flex-row items-center laptop:p-10 mobile:p-4 gap-9 shadow-xl mobile:pt-8 mobile:pb-8'>
