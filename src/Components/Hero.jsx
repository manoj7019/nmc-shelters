...
const Hero = () => {
  return (
    <div className='bg-[url("/seamless.png")] flex flex-col justify-between items-center laptop:px-10 mobile:px-4 laptop:mb-11 mobile:mb-8'>
        <div className='flex flex-col laptop:mt-6 gap-7'>
            <div className='flex flex-col gap-4'>
                <h1 className='text-[#440859] laptop:text-11 mobile:text-8 font-bold leading-tight text-center'>Own a plot at a <span className='text-orange-500'>premium location </span>now!</h1>
